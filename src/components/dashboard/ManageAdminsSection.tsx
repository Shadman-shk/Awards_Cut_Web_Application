...
export function ManageAdminsSection() {
  ...
  const getRoleIcon = (adminRole: AppRole) => {
    switch (adminRole) {
      case "owner":
  ...
  const getRoleBadgeStyle = (adminRole: AppRole) => {
    switch (adminRole) {
      case "owner":
