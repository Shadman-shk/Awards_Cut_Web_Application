...
import { getBranding, updateBranding } from "@/lib/brandingStore";
  ...
  const handleSelect = (id: string, name: string) => {
    ...
    if (template) {
      updateBranding({
        ...
        fontFamily: template.fontStyle || getBranding().fontFamily,
      });
    }
    updateCeremonyProgress("template", true);
    toast({
      title: `${name} selected!`,
      description: "Template saved without removing your logo, colors or music.",
    });
  };
      ...
      <div className="space-y-6">
        ...
        >
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <Button variant="hero" onClick={() => { updateCeremonyProgress("template", true); navigate("/dashboard/branding"); }}>
              Next: Branding
