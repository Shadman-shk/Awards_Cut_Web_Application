...
export default function Login() {
  ...
  useEffect(() => {
    if (!authLoading && !isCheckingMFA && user && !mfaFactorId) {
      navigate(from, { replace: true });
    }
  }, [user, authLoading, navigate, from, mfaFactorId, isCheckingMFA]);
    ...
    <div className="min-h-screen bg-charcoal flex">
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <p className="text-muted-foreground mb-8">Log in to manage your awards ceremonies.</p>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-card items-center justify-center p-12">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-foreground mb-4">Every Winner. Every Moment.</h2>
