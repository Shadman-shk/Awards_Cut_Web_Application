        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <Button variant="hero" size="sm" asChild>
              <Link to="/dashboard/livestream">
                <Radio className="h-4 w-4" /> Start Stream
              </Link>
            </Button>
            <Button variant="hero" size="sm" asChild>
              <Link to="/dashboard/clip-generation">
            ...
            <div className="space-y-2">
              {recentVideos.map((video) => (
                ...
                >
                  ...
                  <Button variant="ghost" size="sm" className="opacity-0 group-hover:opacity-100 transition-opacity duration-150" onClick={() => navigate("/dashboard/editor")}>
                    Edit
                  </Button>
                </div>
              ))}
