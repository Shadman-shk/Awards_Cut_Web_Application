  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "fade-in": "fade-in 0.18s cubic-bezier(0.4,0,0.2,1) forwards",
        "fade-in-left": "fade-in-left 0.3s ease-out forwards",
        "fade-in-right": "fade-in-right 0.3s ease-out forwards",
        "scale-in": "scale-in 0.18s cubic-bezier(0.34,1.56,0.64,1) forwards",
        "float": "float 3s ease-in-out infinite",
        "pulse-glow": "pulse-glow 2s ease-in-out infinite",
        "shimmer": "shimmer 1.5s ease-in-out infinite",
        "count-up": "count-up 0.6s ease-out forwards",
        "modal-in": "modal-in 0.18s cubic-bezier(0.34,1.56,0.64,1) forwards",
      },
    },
  },
